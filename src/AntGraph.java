...
public class AntGraph implements Serializable{
	...
	private static final long serialVersionUID = 1L;
	    ...
	    private double[][] m_delta;      //distance matrix
	    private double[][] m_tau;       //pheomone matrix
	    private int        m_nNodes;   //no of nodes in graph
	    ...
	    public void resetTau()
	    {
	        ...
	        m_dTau0 = (double)1 / ((double)m_nNodes * (0.5 * dAverage)); //all edges hav same amt of pheromone
